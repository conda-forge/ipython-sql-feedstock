...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ipython-sql-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ipython-sql-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ipython-sql
# for installing globally
pixi global install ipython-sql
```
...
It is possible to list all of the versions of `ipython-sql` available on your platform:
...
```
pixi search ipython-sql --channel conda-forge
```
